    ...
    <Link href={`/details/${collectionAddress}`}>
      <div className="w-min h-min bg-white mt-3 rounded-xl border border-gray-200 shadow-md dark:bg-[#1E1E1E] dark:border-[#1E1E1E] mx-auto">
        ...
        <div className="hover:bg-gradient-to-r from-[#6A00FF] to-[#3C00B7] rounded-xl cursor-pointer">
          <div className="h-[13rem] w-[13rem] relative">
            <a title="cardImage" href="#">
              <div className="rounded-xl h-[13rem] w-[13rem] overflow-hidden">
                <div
                  className="rounded-xl h-full w-full child hover:scale-110 transition"
                  style={{
                    backgroundImage: "url(" + `${cachedUri}` + ")",
          ...
          <div className="p-2">
            <a href="#">
              <h5 className="pb-1 text-sm font-semibold text-center tracking-tight text-gray-900 dark:text-white">
                {cachedData && cachedData.name}
              </h5>
            </a>
            <p className="text-xs font-normal text-white text-ellipsis line-2-clip overflow-hidden">
...
function FilterSearch({ filterOptions }) {
  return (
      ...
      <div className="relative">
        <div className="static top-5 left-3">
          <select
            ...
            className="absolute focus:border-transparent focus:ring-0 top-5 h-10 text-white rounded-l-xl bg-[#313131] border-[#383838] left-0"
            title="search"
            name="filters"
            id="filters"
          >
        ...
        <input
          type="text"
          className="h-10 focus:border-transparent focus:ring-0 w-full pl-32 pr-20 text-white bg-[#313131] border-[#383838] flex-auto transition ease-out font-bold rounded-xl placeholder:font-thin placeholder:text-[#FFFFFF33] text-sm px-5 py-3 mr-2 mt-5 mb-5"
        ...
        <div className="absolute top-5 right-0">
          ...
          <button
            title="search"
            className="focus:border-transparent focus:ring-0 h-10 w-10 text-black rounded-xl bg-[#02FF63] hover:bg-[#02FF63] px-[10px]"
          >
            <svg
...
function MyCollectionView({ collections }: MyCollectionViewProps) {
  return (
    <div className="rounded-xl px-3">
      ...
      <header className="w-100 h-16 flex flex-col-2 md:flex-row sticky z-[5] bg-[#121212] pt-3 rounded-xl">
        <h1 className="text-md text-white font-normal px-4 pt-5 w-1/2">
          NFT Collection&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
          <span className="text-md opacity-40 mt-1">
