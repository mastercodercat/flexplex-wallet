                            ...
                            >
                                <Dialog.Panel className="w-full max-w-[30rem] transform overflow-hidden rounded-xl bg-[#1e1e1e] border border-[#383838] text-left align-middle shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none transition-all">
                                    ...
                                    <div className='min-h-[32rem] mb-5 py-3 px-9'>
                                        ...
                                        <div className='grid grid-cols-11 mb-6'>
                                            <div className='flex justify-end rounded-xl col-span-5'>
                                                <button type='button' onClick={() => {setActivePage(1)}} title="1" className='bg-[#1e1e1e] p-1 rounded-2xl text-[#fff] border-2 border-[#6A00FF] h-12 w-12'>
                                                    1
                                                </button>
                                            </div>
                                            <div><hr className='my-6 mx-3 opacity-40' /></div>
                                            <div className='rounded-xl  col-span-5'>
                                                <button type='button' onClick={() => {setActivePage(2)}} title="2" className='bg-[#1e1e1e] p-1 rounded-2xl text-[#fff] border-2 border-[#383838] h-12 w-12'>
                                                    2
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div className='col-span-2 pb-8 px-6 w-full flex justify-center'>
                                        {activePage === 1 && <button onClick={() => {setActivePage(2)}} className="focus:border-transparent focus:ring-0 w-64 text-black bg-[#02ff63] transition ease-out hover:-translate-y-1 hover:scale-100 delay-150 hover:shadow-lg hover:shadow-[#02ff63cc] font-bold rounded-xl text-md p-2 ml-2 mt-3" type="submit">Next</button>}
                                        {activePage === 2 && <button className="focus:border-transparent focus:ring-0 w-64 text-black bg-[#02ff63] transition ease-out hover:-translate-y-1 hover:scale-100 delay-150 hover:shadow-lg hover:shadow-[#02ff63cc] font-semibold rounded-xl text-md p-2 ml-2 mt-3" type="submit">Confirm transaction</button>}
                                    </div>
                                </Dialog.Panel>
                            </Transition.Child>
                        </div>
