...
export default function ExportPrivateKeyModal({ modalHeader, buttonText }) {
                ...
                <Dialog.Panel className="w-full max-w-[30rem] min-h-[42rem] transform overflow-hidden rounded-xl bg-[#1e1e1e] border border-[#383838] text-left align-middle shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none transition-all">
                  ...
                  <div className='min-h-[32rem] mb-5 py-10 px-16'>
                    <div className='h-50 flex justify-center'>
                      {/* QR Code SVG */}
                      <img className='w-32 h-32 mx-auto my-auto' src='/icons/warning.svg' alt='QR Code Icon'></img>
                    </div>
                    <div className='mt-3 border border-[#FFC805] p-4 bg-[#FFC80508] rounded-xl'>
                      <h1 className='text-center pb-2 text-[#FFC805] font-bold text-sm'>Do not share your secret phrase!</h1>
                      <h1 className='text-center text-[#FFC805] text-sm'>If someone has your secret phrase they will Have full control of your wallet.</h1>
                    </div>
                    ...
                    <div className="">
                      <div className="relative">
                        ...
                        <p title='secret' className="focus:outline-none bg-[#313131] w-full border-[#383838] min-h-[9rem] border rounded-xl text-sm p-3 break-words mr-2 mt-5 mb-2">
                        4gChkdDJiJ8KN7p8YwxnjDcYQBD8sXbSTaM96ymKmbsBGUW2zrzQuNxLRsXCYY7CYDv5KJPtPqogoCqGkCgPxKyb
                        </p>
                      </div>
                    </div>
