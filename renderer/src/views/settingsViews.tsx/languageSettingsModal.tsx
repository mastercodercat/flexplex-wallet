...
export default function LanguageSettingsModal({ modalHeader, buttonText }) {
                                        ...
                                        <div className='min-h-[32rem] py-6 px-12'>
                                            <div className='col-span-2 grid grid-cols-4 bg-[#232323] border border-[#383838] rounded-xl w-100 mb-3'>
                                                <div className='col-span-3'>
                                                    <h1 className='text-[#ffffff66] text-left text-xs py-3 pl-6'>English</h1>
                                                </div>
                                                <div className='flex justify-end'>
                                                    <button type='button' title="Revoke" className='focus:border-transparent focus:ring-0 bg-[#272727] px-3 py-2 rounded-xl'>
                                            ...
                                            <div className='col-span-2 grid grid-cols-4 bg-[#232323] border border-[#383838] rounded-xl w-100 mb-3'>
                                                <div className='col-span-3'>
                                                    <h1 className='text-[#ffffff66] text-left text-xs py-3 pl-6'>Español</h1>
                                                </div>
                                            </div>
                                        </div>
