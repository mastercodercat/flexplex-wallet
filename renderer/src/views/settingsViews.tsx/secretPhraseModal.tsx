...
export default function SecretPhraseModal({ modalHeader, buttonText }) {
                  ...
                  <div className='min-h-[32rem] mb-5 py-10 px-16'>
                    ...
                    <div className="">
                      <div className="relative">
                        ...
                        <p title='secret' className="focus:outline-none text-[#02FF63] bg-[#313131] w-full leading-9 border-[#383838] min-h-[9rem] border rounded-xl text-xs p-3 mr-2 mt-5 mb-2">
                          {/* Space After each phrase is Critical */}
                          <span className='p-2 bg-[#cdffcc66] border border-[#02FF63] mr-3 rounded-xl'>coxer </span>
                          <span className='p-2 bg-[#cdffcc66] border border-[#02FF63] mr-3 rounded-xl'>coxer </span>
                          <span className='p-2 bg-[#cdffcc66] border border-[#02FF63] mr-3 rounded-xl'>coxer </span>
                          <span className='p-2 bg-[#cdffcc66] border border-[#02FF63] mr-3 rounded-xl'>coxer </span>
                          <span className='p-2 bg-[#cdffcc66] border border-[#02FF63] mr-3 rounded-xl'>coxer </span>
