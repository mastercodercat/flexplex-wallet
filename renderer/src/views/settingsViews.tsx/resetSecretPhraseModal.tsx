...
export default function ResetSecretPhraseModal({ modalHeader, buttonText }) {
                ...
                <Dialog.Panel className="w-full max-w-[30rem] min-h-[42rem] transform overflow-hidden rounded-xl bg-[#1e1e1e] border border-[#383838] text-left align-middle shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none transition-all">
                  ...
                  <div className='min-h-[32rem] mb-5 py-10 px-16'>
                    <div className='h-50 flex justify-center'>
                      {/* QR Code SVG */}
                      <img className='w-32 h-32 mx-auto my-auto' src='/icons/danger.svg' alt='QR Code Icon'></img>
                    </div>
                    <div className='mt-3 border border-[#FF5C59] p-8 bg-[#FF5C5908] rounded-xl'>
                      <h1 className='text-center text-[#FF5C59] font-bold text-sm'>Resetting your secret <br/>recovery phrase</h1>
                    </div>
                    <h1 className='text-center text-sm mt-8 opacity-60'>This will remove all existing wallets and replace them with new ones. Make sure you have your existing secret phrase and private keys backed up.</h1>
