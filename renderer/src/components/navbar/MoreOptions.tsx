...
export default function MoreOptions(){
    return (
        <Menu as="div" className="relative inline-block text-left">
              ...
              >
                <Menu.Items className="absolute right-0 w-56 p-2 origin-top-right bg-[#1e1e1e] border border-[#383838] divide-y divide-[#383838] rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
