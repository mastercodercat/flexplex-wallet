...
export default function Qr(){
    ...
    return (
        <div className="relative inline-block text-left">
              <div>
                <button onClick={() => {setIsOpen(true)}} className="inline-flex justify-center w-full p-1.5 text-sm font-medium text-white rounded-xl bg-[#02FF63] border border-[#383838] focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
